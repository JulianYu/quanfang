...
- (void)SUN_ShowBadgeOnItemIndex:(int)index{
  //移除之前的小红点
  [self SUN_RemoveBadgeOnItemIndex:index];
  
  //新建小红点
  UIView *badgeView = [[UIView alloc]init];
  badgeView.tag = 888+index;
  badgeView.layer.cornerRadius = 5.f;//圆形
  badgeView.backgroundColor = [UIColor SUN_ColorWithHexString:@"f43530" alpha:1.0];//颜色：红色
...
- (void)SUN_ShowBadgeOnItemIndex:(int)index badgeValue:(int)badgeValue{
  //移除之前的小红点
  [self SUN_RemoveBadgeOnItemIndex:index];
...
//隐藏小红点
- (void)SUN_HideBadgeOnItemIndex:(int)index{
  //移除小红点
  [self SUN_RemoveBadgeOnItemIndex:index];
}

//移除小红点
- (void)SUN_RemoveBadgeOnItemIndex:(int)index{
  //按照tag值进行移除
