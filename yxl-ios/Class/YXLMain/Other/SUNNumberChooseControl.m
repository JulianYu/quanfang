...
@interface SUNNumberChooseControl ()<UITextFieldDelegate>
...
@implementation SUNNumberChooseControl{
    CGSize _contentSize;
    CGFloat _padding;
    CGFloat _fontSize;
}
...
- (UIButton *) decreaseButton {
    if (!_decreaseButton) {
        ...
        _decreaseButton.layer.borderColor = SUN_GlobalWhiteColor.CGColor;
...
- (UITextField *) textField {
    if (!_textField) {
        ...
        _textField.layer.borderColor = SUN_GlobalWhiteColor.CGColor;
...
- (UIButton *) increaseButton {
    if (!_increaseButton) {
        ...
        _increaseButton.layer.borderColor = SUN_GlobalWhiteColor.CGColor;
