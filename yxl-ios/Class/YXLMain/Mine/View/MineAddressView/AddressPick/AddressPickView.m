...
-(void)_createView
{
    ...
    _bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, SUN_NavigationH+pickViewViewHeight)];
    [self addSubview:_bottomView];
    //导航视图
    _navigationView = [[UIView alloc]initWithFrame:CGRectMake(0, 65, SCREEN_WIDTH, SUN_NavigationH)];
    ...
    for (int i = 0; i <buttonTitleArray.count ; i++) {
        ...
        button.frame = CGRectMake(i*(SCREEN_WIDTH-buttonWidth)/2, 0, buttonWidth, SUN_NavigationH);
        [button setTitle:buttonTitleArray[i] forState:UIControlStateNormal];
        [button setTitleColor:SUN_GlobalTextGreyColor forState:UIControlStateNormal];
    ...
    _pickView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, SUN_NavigationH+65, SCREEN_WIDTH, pickViewViewHeight)];
...
-(void)showBottomView
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        _bottomView.top = SCREEN_HEIGHT-SUN_NavigationH-pickViewViewHeight-64;
        self.backgroundColor = [UIColor SUN_ColorWithHexString:@"#000000" alpha:0.2];
